...
func RegisterHandlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	...
	server.AddRoutes([]rest.Route{
		...
		{Method: http.MethodGet, Path: "/api/campus-map", Handler: CampusLayoutHandler(serverCtx)},
	}, jwtOpt)
	...
	server.AddRoutes(rest.WithMiddleware(auth.RoleGuard(2), []rest.Route{
		...
		{Method: http.MethodGet, Path: "/api/worker/duty-status", Handler: WorkerDutyStatusHandler(serverCtx)},
	...
	server.AddRoutes(rest.WithMiddleware(auth.RoleGuard(1), []rest.Route{
		...
		{Method: http.MethodGet, Path: "/api/admin/work-settings", Handler: AdminWorkSettingsHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/api/admin/work-settings", Handler: AdminWorkSettingsUpdateHandler(serverCtx)},
		...
		{Method: http.MethodGet, Path: "/api/admin/campus-templates", Handler: CampusTemplateListHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/api/admin/campus-templates", Handler: CampusTemplateSaveHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/api/admin/campus-templates/:id", Handler: CampusTemplateGetHandler(serverCtx)},
		{Method: http.MethodPut, Path: "/api/admin/campus-templates/:id", Handler: CampusTemplateRenameHandler(serverCtx)},
		{Method: http.MethodDelete, Path: "/api/admin/campus-templates/:id", Handler: CampusTemplateDeleteHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/api/admin/campus-templates/:id/apply", Handler: CampusTemplateApplyHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/api/admin/campus-backups", Handler: CampusBackupListHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/api/admin/campus-backups", Handler: CampusBackupCreateHandler(serverCtx)},
		{Method: http.MethodPut, Path: "/api/admin/campus-backups/keep", Handler: CampusBackupKeepHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/api/admin/campus-backups/:id/restore", Handler: CampusBackupRestoreHandler(serverCtx)},
